...
public class JPanelTeacher extends JPanelBase<Teacher> {
    ...
    protected void setRowValues(int row, Teacher entity) {
        ...
        tableModel.setValueAt(entity.getAssignedStudents(), row, 4);
    }
    ...
    private void initComponents() {
        ...
        tableModel = new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                        bundle.getString("dictionary.code"), bundle.getString("dictionary.names"), bundle.getString("dictionary.birthday"), bundle.getString("dictionary.email"), bundle.getString("dictionary.assigned")
                }
        ) {
